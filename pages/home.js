    ...
    <Head>
      ...
      <header className="flex justify-around items-center py-4">
        <div className="relative w-36 h-10">
          <img src="https://rb.gy/vtbzlp" layout="fill" objectFit="contain" />
        </div>
...
{Object.values(providers).map((provider)=>(
    <div key={provider.name}>
          <div className="pl-4">
            <button className="text-blue-700 font-semibold rounded-full border border-blue-700 px-5 py-1.5 transition-all"
...
<div className='relative xl:absolute w-80 h-80 xl:w-[650px] xl:h-[650px] top-20 right-5 '>
    <img src="https://rb.gy/vkzpzt" layout='fill' priority={true} />
</div>
