    ...
    >
      ...
      <div className="flex justify-evenly items-center dark:border-t border-gray-600/80 mx-2.5 pt-2 text-black/60 dark:text-white/75">
        {modalPost ? (
          ...
          >
            {liked ? (
              <ThumbUpOffAltRoundedIcon className="-scale-x-100 text-blue-500" onClick={()=>setLiked(false)} />
            ) : (
              <ThumbUpOffAltOutlinedIcon className="-scale-x-100" onClick={()=>setLiked(true)} />
            )}
