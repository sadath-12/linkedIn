...
<div className='mt-5 py-4 space-y-0.5 '>
    <h4 className='hover:underline decoration-purple-700 underline-offset-2'>{session?.user?.name}</h4>
    <p className='text-black/60 dark:text-white/75 text-sm'>{session?.user?.email}</p>
</div>

<div className='hidden md:inline text-left dark:white/75 text-sm '>
